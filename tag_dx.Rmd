...
## Set root path for work computer (this can also be a working folder on CAS)
```{r}
...
dx_full$Wave_4_C <- paste(dx_full$W4_current)
dx_full$Wave_4_P <- paste(dx_full$W4_past)
...
dx_full$Wave_4_C[dx_full$Wave_3_C=="1"] = "4"
dx_full$Wave_4_P[dx_full$Wave_3_P=="1"] = "4"

dx_full <- dx_full %>%
  unite("Wave", Wave_1_C:Wave_1_P:Wave_2_C:Wave_2_P:Wave_3_C:Wave_3_P, Wave_4_C:Wave_4_P)
                                   ...
                                   ifelse(Wave=="NA_NA_NA_2_NA_NA", "2",
                                          ifelse(Wave=="NA_NA_NA_NA_3_NA", "3",
                                                 ifelse(Wave=="NA_NA_NA_NA_NA_3", "3",
                                                        ifelse(Wave=="NA_NA_NA_NA_NA_NA_4_NA", "4",
                                                               ifelse(Wave=="NA_NA_NA_NA_NA_NA_4", "4",
                                                        Wave)))))))
